...
* current state: with the sample data structure it is possible to read in 2D DXF files and 
store lines and arcs as database elements. The drawings can be displayed on screen and distributed 
over network. Yeah !
- Next step to do is managing the UNDO journal and database reorganisation
